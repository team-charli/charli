/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4d18afffd97e7e1e0018b70091b0b839)
// Runtime types generated with workerd@1.20250525.0 2025-03-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		LEARNER_ASSESSMENT_DO: DurableObjectNamespace<import("./src/index").LearnerAssessmentDO>;
		MESSAGE_RELAY_DO: DurableObjectNamespace<import("./src/index").MessageRelayDO>;
		SCORECARD_ORCHESTRATOR_DO: DurableObjectNamespace<import("./src/index").ScorecardOrchestratorDO>;
		SCORECARD_PERSISTER_DO: DurableObjectNamespace<import("./src/index").ScorecardPersisterDO>;
		MISTAKE_ANALYZER_DO: DurableObjectNamespace<import("./src/index").MistakeAnalyzerDO>;
		MISTAKE_DETECTOR_DO: DurableObjectNamespace<import("./src/index").MistakeDetectorDO>;
		MISTAKE_ENRICHER_PIPELINE_DO: DurableObjectNamespace<import("./src/index").MistakeEnricherPipelineDO>;
		AVG_FREQUENCY_ENRICHER_DO: DurableObjectNamespace<import("./src/index").AvgFrequencyEnricherDO>;
		SESSION_FREQ_COLOR_ENRICHER_DO: DurableObjectNamespace<import("./src/index").SessionFrequencyColorEnricherDO>;
		LEMMA_ENRICHER_DO: DurableObjectNamespace<import("./src/index").LemmaEnricherDO>;
		PCM_TO_WAV_WORKER: Fetcher /* pcm-to-wav-worker */;
		HEY_CHARLI_WORKER: Fetcher /* hey-charli-worker */;
		AI: Ai;
	}
}
