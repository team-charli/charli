  ...
  return (
    <>
     ...
     <BannerHeader />
      ...
      <ButtonLink path="/login" onButtonClick={() => {/*console.log('setOnboardMode Learn');*/ return setOnboardMode("Learn")}} data-cy="learn-button">Learn 🎓 </ButtonLink>
      <ButtonLink path="/login" onButtonClick={() => {/*console.log("setOnboardMode Teach");*/setOnboardMode("Teach")}}data-cy="teach-button">Teach 🤑</ButtonLink>
      </div>
    </>
  );
}
